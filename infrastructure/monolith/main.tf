...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  # source_arn = "${aws_api_gateway_rest_api.monolith_api.arn}/*/${aws_api_gateway_method.root_post_method.http_method}/"
  
  # source_arn = "arn:aws:execute-api:af-south-1:767398121047:${aws_api_gateway_rest_api.monolith_api.id}/*/${aws_api_gateway_method.root_post_method.http_method}${aws_api_gateway_resource.resource.path}"
